...
一个给自己用的 Windows 专注应用。

如果你打开电脑本来想学习，结果一转眼就在网页之间来回乱逛，一会儿看QQ一会儿看微信，那你就来对地方了。Focus Desk 想做的事情很简单：把真正需要的资料和网站放在眼前，把那些下意识的“顺手打开”变得麻烦一点。

它不是家长控制软件，也不是把电脑锁死的工具。你仍然可以离开，只是平时不再那么容易被一时冲动带跑。
...
- 用一个全屏的专注桌面承载学习资料、番茄钟和学习网页；
- 只显示你选择的网站，也可以自己添加网址；
- 在应用里直接浏览 PDF、图片和 TXT 等学习资料；
- 提供番茄钟，并支持可选的 Hard Focus 模式（在规定的时间，除了重启电脑和 Ctrl+Alt+Del 没有其他退出方式）；
- 退出时要求输入你自己设置的短语，给你上点道德压力，减少无意识退出；
